# Ship Checklist: feature saberes-necesarios
...
**Security Report:** `.specify/specs/001/security-report.md`
...
| Item | Owner | Due Date |
|------|-------|----------|
| [Item 1] | Rony Quispe | [Date] |
| [Item 2] | Rony Quispe | [Date] |
